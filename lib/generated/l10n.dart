...
class S {
  ...
  /// `Save Master Node`
  String get save_master_node {
    return Intl.message(
      'Save Master Node',
      name: 'save_master_node',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Delete Master Node`
  String get delete_master_node {
    return Intl.message(
      'Delete Master Node',
      name: 'delete_master_node',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Add Master Node`
  String get title_add_master_node {
    return Intl.message(
      'Add Master Node',
      name: 'title_add_master_node',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Edit Master Node`
  String get title_edit_master_node {
    return Intl.message(
      'Edit Master Node',
      name: 'title_edit_master_node',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Edit Master Nodes`
  String get title_edit_master_nodes {
    return Intl.message(
      'Edit Master Nodes',
      name: 'title_edit_master_nodes',
      desc: '',
      args: [],
    );
  }
  ...
  String all_master_nodes(Object networkSize, Object currentHeight) {
    return Intl.message(
      '$networkSize nodes at height $currentHeight',
  ...
  /// `Your Master Nodes`
  String get your_master_nodes {
    return Intl.message(
      'Your Master Nodes',
      name: 'your_master_nodes',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Node Version`
  String get master_node_version {
    return Intl.message(
      'Node Version',
      name: 'master_node_version',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Node Operator`
  String get master_node_operator {
    return Intl.message(
      'Node Operator',
      name: 'master_node_operator',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Master Nodes`
  String get settings_master_nodes {
    return Intl.message(
      'Master Nodes',
      name: 'settings_master_nodes',
      desc: '',
      args: [],
    );
  }
